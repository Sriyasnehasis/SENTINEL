...
export const hospitalData = {
  ...
  nodes: {
    ...
    "Stair-A-G":     { name: "Stairwell A - Ground",          type: "stair",    floor: 0, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50, coords: [22, 0, -10] },
    "Stair-B-G":     { name: "Stairwell B - Ground",          type: "stair",    floor: 0, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50, coords: [-22, 0, -10] },
    "Stair-C-G":     { name: "Stairwell C - Ground (Fire)",   type: "stair",    floor: 0, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50, coords: [22, 0, 10] },
    "Stair-D-G":     { name: "Stairwell D - Ground (Fire)",   type: "stair",    floor: 0, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50, coords: [-22, 0, 10] },
    "Elevator-1-G":  { name: "Elevator Bank 1 - Ground",      type: "elevator", floor: 0, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 20, coords: [10, 0, -12] },
    "Elevator-2-G":  { name: "Elevator Bank 2 - Ground",      type: "elevator", floor: 0, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 20, coords: [-10, 0, -12] },
    "FE-East-G":     { name: "East Fire Escape Exit",         type: "escape",   floor: 0, wing: "External",   equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 15, coords: [28, 0, 0] },
    "FE-West-G":     { name: "West Fire Escape Exit",         type: "escape",   floor: 0, wing: "External",   equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 15, coords: [-28, 0, 0] },

    // === GROUND FLOOR (ER) ===
    "ER-G-Entrance":    { name: "ER Main Entrance",       type: "corridor", floor: 0, wing: "ER Wing", equipment: { hasExtinguisher: true, hasAED: true,  hasOxygenValve: false }, maxCapacity: 200, coords: [0, 0, -28] },
    ...
    "ER-G-Ambulance":   { name: "Ambulance Arrival Hub",  type: "corridor", floor: 0, wing: "ER Wing", equipment: { hasExtinguisher: true, hasAED: true,  hasOxygenValve: true  }, maxCapacity: 20,  coords: [15, 0, -42] },
    ...
    "OPD-G-Cardiology":  { name: "OPD Cardiology Unit",  type: "ward",     floor: 0, wing: "OPD Wing", equipment: { hasExtinguisher: true, hasAED: true,  hasOxygenValve: true  }, maxCapacity: 40,  coords: [-48, 0, 10] },
    ...
    "Stair-OPD-G":       { name: "OPD Stairwell - Ground",type: "stair",  floor: 0, wing: "OPD Wing", equipment: { hasExtinguisher: true, hasAED: false, hasOxygenValve: false }, maxCapacity: 40,  coords: [-50, 0, -8] },
    ...
    "Stair-A-1":        { name: "Stairwell A - F1",      type: "stair",         floor: 1, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [22, 5, -10] },
    "Stair-B-1":        { name: "Stairwell B - F1",      type: "stair",         floor: 1, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [-22, 5, -10] },
    "Stair-C-1":        { name: "Stairwell C - F1 (Fire)",type: "stair",        floor: 1, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [22, 5, 10] },
    "Stair-D-1":        { name: "Stairwell D - F1 (Fire)",type: "stair",        floor: 1, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [-22, 5, 10] },
    "Elevator-1-1":     { name: "Elevator Bank 1 - F1",  type: "elevator",      floor: 1, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 20,  coords: [10, 5, -12] },
    "Elevator-2-1":     { name: "Elevator Bank 2 - F1",  type: "elevator",      floor: 1, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 20,  coords: [-10, 5, -12] },
    "FE-East-1":        { name: "East Fire Escape F1",   type: "escape",        floor: 1, wing: "External",   equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 15,  coords: [28, 5, 0] },
    "FE-West-1":        { name: "West Fire Escape F1",   type: "escape",        floor: 1, wing: "External",   equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 15,  coords: [-28, 5, 0] },
    ...
    "Bridge-MT-ER-1":    { name: "MT-ER Skybridge F1",    type: "corridor", floor: 1, wing: "Shared",     equipment: { hasExtinguisher: true, hasAED: false, hasOxygenValve: false }, maxCapacity: 30,  coords: [0, 5, -22] },
    ...
    "ICU-1-WardA":       { name: "General ICU A",         type: "ward",          floor: 1, wing: "ICU Wing", equipment: { hasExtinguisher: true, hasAED: true, hasOxygenValve: true  }, maxCapacity: 20,  coords: [55, 5, 8] },
    "ICU-1-WardB":       { name: "General ICU B",         type: "ward",          floor: 1, wing: "ICU Wing", equipment: { hasExtinguisher: true, hasAED: true, hasOxygenValve: true  }, maxCapacity: 20,  coords: [55, 5, -8] },
    ...
    "Bridge-MT-ICU-1":   { name: "MT-ICU Skybridge F1",   type: "corridor",      floor: 1, wing: "Shared",   equipment: { hasExtinguisher: true, hasAED: false, hasOxygenValve: false }, maxCapacity: 30, coords: [35, 5, 0] },
    "Stair-ICU-1":       { name: "ICU Stairwell - F1",    type: "stair",         floor: 1, wing: "ICU Wing", equipment: { hasExtinguisher: true, hasAED: false, hasOxygenValve: false }, maxCapacity: 40, coords: [55, 5, -12] },
    ...
    "OPD-1-Dermatology": { name: "OPD Dermatology",       type: "ward",     floor: 1, wing: "OPD Wing", equipment: { hasExtinguisher: true, hasAED: true,  hasOxygenValve: true  }, maxCapacity: 30,  coords: [-50, 5, 8] },
    "OPD-1-ENT":         { name: "OPD ENT Unit",          type: "ward",     floor: 1, wing: "OPD Wing", equipment: { hasExtinguisher: true, hasAED: true,  hasOxygenValve: true  }, maxCapacity: 30,  coords: [-50, 5, -8] },
    "Bridge-MT-OPD-1":   { name: "MT-OPD Skybridge F1",   type: "corridor", floor: 1, wing: "Shared",   equipment: { hasExtinguisher: true, hasAED: false, hasOxygenValve: false }, maxCapacity: 30,  coords: [-33, 5, 0] },
    "Stair-OPD-1":       { name: "OPD Stairwell - F1",    type: "stair",    floor: 1, wing: "OPD Wing", equipment: { hasExtinguisher: true, hasAED: false, hasOxygenValve: false }, maxCapacity: 40,  coords: [-52, 5, -8] },
    ...
    "Stair-A-2":        { name: "Stairwell A - F2",       type: "stair",         floor: 2, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [22, 10, -10] },
    "Stair-B-2":        { name: "Stairwell B - F2",       type: "stair",         floor: 2, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [-22, 10, -10] },
    "Stair-C-2":        { name: "Stairwell C - F2 (Fire)",type: "stair",         floor: 2, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [22, 10, 10] },
    "Stair-D-2":        { name: "Stairwell D - F2 (Fire)",type: "stair",         floor: 2, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [-22, 10, 10] },
    "Elevator-1-2":     { name: "Elevator Bank 1 - F2",   type: "elevator",      floor: 2, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 20,  coords: [10, 10, -12] },
    "Elevator-2-2":     { name: "Elevator Bank 2 - F2",   type: "elevator",      floor: 2, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 20,  coords: [-10, 10, -12] },
    "FE-East-2":        { name: "East Fire Escape F2",    type: "escape",        floor: 2, wing: "External",   equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 15,  coords: [28, 10, 0] },
    "FE-West-2":        { name: "West Fire Escape F2",    type: "escape",        floor: 2, wing: "External",   equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 15,  coords: [-28, 10, 0] },
    ...
    "ICU-2-NeoNatal":   { name: "NICU (Neonatal)",        type: "ward",     floor: 2, wing: "ICU Wing", equipment: { hasExtinguisher: true, hasAED: true, hasOxygenValve: true }, maxCapacity: 30,  coords: [55, 10, 8] },
    "ICU-2-Cardio":     { name: "CICU (Cardio)",          type: "ward",     floor: 2, wing: "ICU Wing", equipment: { hasExtinguisher: true, hasAED: true, hasOxygenValve: true }, maxCapacity: 30,  coords: [55, 10, -8] },
    "Bridge-MT-ICU-2":  { name: "MT-ICU Skybridge F2",   type: "corridor",  floor: 2, wing: "Shared",   equipment: { hasExtinguisher: true, hasAED: false, hasOxygenValve: false }, maxCapacity: 30, coords: [35, 10, 0] },
    "Stair-ICU-2":      { name: "ICU Stairwell - F2",     type: "stair",    floor: 2, wing: "ICU Wing", equipment: { hasExtinguisher: true, hasAED: false, hasOxygenValve: false }, maxCapacity: 40, coords: [55, 10, -12] },
    ...
    "Stair-A-3":        { name: "Stairwell A - F3",       type: "stair",         floor: 3, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [22, 15, -10] },
    "Stair-B-3":        { name: "Stairwell B - F3",       type: "stair",         floor: 3, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [-22, 15, -10] },
    "Stair-C-3":        { name: "Stairwell C - F3 (Fire)",type: "stair",         floor: 3, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [22, 15, 10] },
    "Stair-D-3":        { name: "Stairwell D - F3 (Fire)",type: "stair",         floor: 3, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [-22, 15, 10] },
    "Elevator-1-3":     { name: "Elevator Bank 1 - F3",   type: "elevator",      floor: 3, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 20,  coords: [10, 15, -12] },
    "Elevator-2-3":     { name: "Elevator Bank 2 - F3",   type: "elevator",      floor: 3, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 20,  coords: [-10, 15, -12] },
    "FE-East-3":        { name: "East Fire Escape F3",    type: "escape",        floor: 3, wing: "External",   equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 15,  coords: [28, 15, 0] },
    "FE-West-3":        { name: "West Fire Escape F3",    type: "escape",        floor: 3, wing: "External",   equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 15,  coords: [-28, 15, 0] },
    ...
    "Stair-A-4":        { name: "Stairwell A - F4",       type: "stair",         floor: 4, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [22, 20, -10] },
    "Stair-B-4":        { name: "Stairwell B - F4",       type: "stair",         floor: 4, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [-22, 20, -10] },
    "Stair-C-4":        { name: "Stairwell C - F4 (Fire)",type: "stair",         floor: 4, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [22, 20, 10] },
    "Stair-D-4":        { name: "Stairwell D - F4 (Fire)",type: "stair",         floor: 4, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50,  coords: [-22, 20, 10] },
    "Elevator-1-4":     { name: "Elevator Bank 1 - F4",   type: "elevator",      floor: 4, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 20,  coords: [10, 20, -12] },
    "Elevator-2-4":     { name: "Elevator Bank 2 - F4",   type: "elevator",      floor: 4, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 20,  coords: [-10, 20, -12] },
    "FE-East-4":        { name: "East Fire Escape F4",    type: "escape",        floor: 4, wing: "External",   equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 15,  coords: [28, 20, 0] },
    "FE-West-4":        { name: "West Fire Escape F4",    type: "escape",        floor: 4, wing: "External",   equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 15,  coords: [-28, 20, 0] },

    // === FLOOR 5 / ROOF (MT) ===
    "MT-5-RoofAccess":  { name: "Roof Access Hub",        type: "corridor", floor: 5, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 50, coords: [0, 25, 0] },
    "MT-5-Helipad":     { name: "MedEvac Helipad",        type: "assembly", floor: 5, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: true,  hasOxygenValve: false }, maxCapacity: 30, coords: [0, 25, -15] },
    "Stair-A-5":        { name: "Stairwell A - Roof",     type: "stair",    floor: 5, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 40, coords: [22, 25, -10] },
    "Elevator-1-5":     { name: "Elevator Bank 1 - Roof", type: "elevator", floor: 5, wing: "Main Tower", equipment: { hasExtinguisher: true,  hasAED: false, hasOxygenValve: false }, maxCapacity: 20, coords: [10, 25, -12] },
  },
